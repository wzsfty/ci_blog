...
<script type="text/javascript" src="<?php echo base_url() ?>org/ueditor/ueditor.all.min.js"></script>
    ...
    <body style="background-image: url(<?php echo base_url().'style/admin/add/'?>img/bgpicture.jpg); background-size: 100% auto; ">
        <div class="content">
            ...
            <form class="main_form" method="POST" action="<?php echo site_url('admin/article/modify/'.$v['aid'])?>">
                <div class="article_title">
                    <label class="title_label">文章标题</label>
                    <input class="title_text" name="a_title"  value="<?php  echo $v['title']?>" type="text" >
                ...
                <div class="article_tag">
                    ...
                    <input name="a_tag" id="tags" value="<?php  $i=count($tags); for($j=0;$j<$i;$j++) echo $tags[$j]['tag'].",";?>">
                </div>

                 <button class="btn" type="submit" name="submit">提交修改&nbsp<img src="<?php echo base_url().'style/admin/add/'  ?>img/letter.png" width="20px" height="20px" alt=""></button>
                <div class="article_describe">
                    <label class="describe_label">文章描述</label>
                    <input class="describe_text" name="a_describe" type="text" value="<?php  echo  $v['a_describe'];?>">
               ...
               <div class="article_classify">
                    ...
                    <td>
                        ...
                        <option  value=" <?php echo $c['cid']?>" ><?php echo $v['cname'] ?></option>
                    <?php endforeach?>
                ...
                <div class="article_content" id="content" >
                        ...
                        <textarea name="a_content" class="content_area" value="<?php  echo set_value('a_content');?>" ><?php  echo $v['content'];?>
                        </textarea>
